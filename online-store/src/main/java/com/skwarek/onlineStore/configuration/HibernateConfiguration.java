...
@ComponentScan(basePackages = { "com.skwarek.onlineStore.data.entity" })
@PropertySource(value = { "classpath:application.properties", "file:/Users/Michal/Desktop/database.txt" })
