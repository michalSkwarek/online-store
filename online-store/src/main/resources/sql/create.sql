...
-- ----------------------------------------------
-- add few addresses
INSERT INTO address (id, street, street_number, door_number, zip_code, city) VALUES (1, 'Koszycka', '6A', '25', '01-446', 'Warszawa');
INSERT INTO address (id, street, street_number, door_number, zip_code, city) VALUES (2, 'Tyszkiewicza', '28', '3', '01-182', 'Warszawa');
INSERT INTO address (id, street, street_number, zip_code, city) VALUES (3, 'Syta', '50', '01-446', 'Warszawa');
INSERT INTO address (id, street, street_number, door_number, zip_code, city) VALUES (4, 'Krowoderska', '61', '12', '31-141', 'Krakow');
INSERT INTO address (id, street, street_number, zip_code, city) VALUES (5, 'Osiedlowa', '10B', '31-964', 'Krakow');
...
-- add few accounts
INSERT INTO account (id, username, password, enabled, email, date_created, role, customer_id) VALUES (1, 'aaa', '111', 1, 'a1@gmail.com', STR_TO_DATE('21-03-2007 05:31:55', '%d-%m-%Y %H:%i:%s'), 'ROLE_USER', 1);
INSERT INTO account (id, username, password, enabled, email, date_created, role, customer_id) VALUES (2, 'bbb', '222', 1, 'b2@gmail.com', STR_TO_DATE('14-11-2008 20:22:31', '%d-%m-%Y %H:%i:%s'), 'ROLE_USER', 2);
INSERT INTO account (id, username, password, enabled, email, date_created, role, customer_id) VALUES (3, 'ccc', '333', 1, 'c3@gmail.com', STR_TO_DATE('05-06-2009 11:44:07', '%d-%m-%Y %H:%i:%s'), 'ROLE_USER', 3);
INSERT INTO account (id, username, password, enabled, email, date_created, role) VALUES (4, 'yyy', '888', 1, 'y8@gmail.com', STR_TO_DATE('22-12-2015 16:24:00', '%d-%m-%Y %H:%i:%s'), 'ROLE_ADMIN');
INSERT INTO account (id, username, password, enabled, email, date_created, role) VALUES (5, 'zzz', '999', 1, 'z9@gmail.com', STR_TO_DATE('01-01-2016 23:01:50', '%d-%m-%Y %H:%i:%s'), 'ROLE_ADMIN');



-- ----------------------------------------------
-- add few shipping details
INSERT INTO shipping_detail (id, date_delivery, shipping_address_id) VALUES (1, STR_TO_DATE('21-03-2016 18:22:33', '%d-%m-%Y %H:%i:%s'), 1);
INSERT INTO shipping_detail (id, date_delivery, shipping_address_id) VALUES (2, STR_TO_DATE('03-04-2016 17:20:03', '%d-%m-%Y %H:%i:%s'), 2);
INSERT INTO shipping_detail (id, date_delivery, shipping_address_id) VALUES (3, STR_TO_DATE('13-05-2016 08:47:22', '%d-%m-%Y %H:%i:%s'), 2);
INSERT INTO shipping_detail (id, date_delivery, shipping_address_id) VALUES (4, STR_TO_DATE('24-06-2016 23:52:45', '%d-%m-%Y %H:%i:%s'), 2);

-- add few orders
INSERT INTO orders (id, cart_total_price, customer_id, shipping_detail_id, date_created) VALUES (1, 13676, 1, 1, STR_TO_DATE('19-03-2016 18:22:33', '%d-%m-%Y %H:%i:%s'));
INSERT INTO orders (id, cart_total_price, customer_id, shipping_detail_id, date_created) VALUES (2, 18355, 2, 2, STR_TO_DATE('01-04-2016 17:20:03', '%d-%m-%Y %H:%i:%s'));
INSERT INTO orders (id, cart_total_price, customer_id, shipping_detail_id, date_created) VALUES (3, 8178, 2, 3, STR_TO_DATE('11-05-2016 08:47:22', '%d-%m-%Y %H:%i:%s'));
INSERT INTO orders (id, cart_total_price, customer_id, shipping_detail_id, date_created) VALUES (4, 16407, 2, 4, STR_TO_DATE('22-06-2016 23:52:45', '%d-%m-%Y %H:%i:%s'));