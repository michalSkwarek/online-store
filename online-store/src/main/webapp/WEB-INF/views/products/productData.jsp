    ...
    <form:form action="?${_csrf.parameterName}=${_csrf.token}" method="post" modelAttribute="product" enctype="multipart/form-data">
        <fieldset>
            ...
            <div class="box">
                ...
                <div>
                    <form:input path="model" id="model" cssClass="field" />
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div>
                    <form:input path="unitPrice" id="unitPrice" cssClass="field" />
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div>
                    <form:input path="unitsInMagazine" id="unitsInMagazine" cssClass="field"/>
                </div>
            </div>
