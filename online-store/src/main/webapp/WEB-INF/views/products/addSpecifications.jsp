            ...
            <fieldset>
                ...
                <c:if test="${spec.cpu != null}">
                    <div class="box">
                        ...
                        <label for="lowClockSpeed" class="title"><spring:message code="specifications.details.cpu.lowClockSpeed.label" /> (only GHz)</label>
                        <div><form:input path="cpu.lowClockSpeed" id="lowClockSpeed" cssClass="input-field" /></div>
                        <label for="highClockSpeed" class="title"><spring:message code="specifications.details.cpu.highClockSpeed.label" /> (only GHz)</label>
                ...
                <c:if test="${spec.gpu != null}">
                    <div class="box">
                        ...
                        <label for="memory" class="title"><spring:message code="specifications.details.gpu.memory.label" /></label>
