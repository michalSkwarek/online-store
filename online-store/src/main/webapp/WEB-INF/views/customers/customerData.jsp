        ...
        <form:form modelAttribute="customer" method="post">
            <fieldset>
                ...
                <div class="box">
                    ...
                    <div>
                        <form:input path="firstName" id="firstName" cssClass="input-field" />
                    </div>
                </div>
                ...
                <div class="box">
                    ...
                    <div>
                        <form:input path="lastName" id="lastName" cssClass="input-field" />
                    </div>
                </div>
                ...
                <div class="box">
                    ...
                    <div>
                        <form:input path="birthDate" id="birthDate" cssClass="input-field" />
                    </div>
                </div>
                ...
                <div class="box">
                    ...
                    <div>
                        <form:input path="phoneNumber" id="phoneNumber" cssClass="input-field" />
                    </div>
                </div>
